...
import com.practice.book.springboot.web.dto.PostsSaveRequestsDto;
...
public class PostsService {
    ...
    @Transactional
    public Long update(Long id, PostsUpdateRequestDto requsetDto) {
        Posts posts = postsRepository.findById(id).orElseThrow(() ->
                new IllegalArgumentException("해당 게시글이 없습니다. id = " + id));

        posts.update(requsetDto.getTitle(), requsetDto.getContent());
